...
int CabacPPartionning (CABACContext *cabac, unsigned char *cabac_state, SLICE *Slice, RESIDU *CurrentResidu, DATA *TabBlock, 
					   CABAC_NEIGH *Neigh,  unsigned char *SliceTable, unsigned char NonZeroCountCache [], short mv_cache_l0[][2], 
					   short ref_cache_l0[], const short iMb_x, const short iMb_y, int DctAllowed, int *LastQP, int *MbQpDelta)
{  
