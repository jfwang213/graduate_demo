...
void resize_residu(const  SPS *sps, RESIDU *residu
		, short luma_residu[], short Cb_residu[], short Cr_residu[]
		, int x_mbPartIdx, int y_mbPartIdx,int transform_8x8_size
		, const short base_Width, const short base_Height,const short curr_Width,const short curr_Height, int *cbp);
