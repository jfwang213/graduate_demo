...
static __inline void SetInterParam(const NAL *Nal, short mv_cache[2], short *ref_cache, const short *MvdL0, short *mv_l0, short *ref_bas_l0){
	...
	mv_cache [0] = MV_CAL(mv_l0[0], Nal -> up_Width, Nal -> down_Width) + MvdL0 [0];
	mv_cache [1] = MV_CAL(mv_l0[1], Nal -> up_Height, Nal -> down_Height) + MvdL0 [1];
}
...
static __inline void SetInterParamHori(const NAL *Nal, short mv_cache[][2], short *ref_cache, const short *MvdL0, short *mv_l0, short *ref_bas_l0){
	...
	mv_cache [0][0] = mv_cache [1][0] = MV_CAL(mv_l0[0], Nal -> up_Width, Nal -> down_Width) + MvdL0 [0];
	mv_cache [0][1] = mv_cache [1][1] = MV_CAL(mv_l0[1], Nal -> up_Height, Nal -> down_Height) + MvdL0 [1];
}
...
static __inline void SetInterParamVert(const NAL *Nal, short mv_cache[][2], short *ref_cache, const short *MvdL0, short *mv_l0, short *ref_bas_l0){
	...
	mv_cache [0][0] = mv_cache [8][0] = MV_CAL(mv_l0[0], Nal -> up_Width, Nal -> down_Width) + MvdL0 [0];
	mv_cache [0][1] = mv_cache [8][1] = MV_CAL(mv_l0[1], Nal -> up_Height, Nal -> down_Height) + MvdL0 [1];
}
#endif
