...
void Decode_I_BL(RESIDU *CurrResidu, const RESIDU *BaseResidu, const PPS *pps, const short PicWidthInPix, const W_TABLES *quantif, const STRUCT_PF * Allpf_struct
