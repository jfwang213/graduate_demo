...
void decode_chroma (short image_Cb [], short image_Cr [], const RESIDU *CurrResidu, const PPS *Pps, const short PicWidthInPix, const W_TABLES *Quantif)
{
...
*/
void base_chroma (short image_Cb [], short image_Cr [], const RESIDU *CurrResidu, const PPS *Pps, const short PicWidthInPix, const W_TABLES *Quantif)
{
