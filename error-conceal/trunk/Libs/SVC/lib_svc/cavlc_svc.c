		...
		if ( Current_residu -> Cbp > 0 || (Current_residu -> MbType == INTRA_16x16)) {
			...
			*last_QP = Current_residu -> Qp = (*last_QP + mb_qp_delta + 52) % 52;
			...
			aio_tiNon_zero_count_cache [12]	= aio_tiNon_zero_count_cache [13] = aio_tiNon_zero_count_cache [14] = aio_tiNon_zero_count_cache [15] = 
				...
				aio_tiNon_zero_count_cache [36] = aio_tiNon_zero_count_cache [37] = aio_tiNon_zero_count_cache [38] = aio_tiNon_zero_count_cache [39] = 
				aio_tiNon_zero_count_cache [ 9] = aio_tiNon_zero_count_cache [10] = aio_tiNon_zero_count_cache [17] = aio_tiNon_zero_count_cache [18] = 
				aio_tiNon_zero_count_cache [33] = aio_tiNon_zero_count_cache [34] =	aio_tiNon_zero_count_cache [41] = aio_tiNon_zero_count_cache [42] = 0;
