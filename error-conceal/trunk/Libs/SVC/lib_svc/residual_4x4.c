...
*/
void base_Intra4x4_lum ( short image [], const RESIDU *CurrResidu, const short PicWidthInPix, const short W4x4_inter [6][16])
{
    int i8x8 ;
    short luma_coeff [16];
...
*/
void Intra4x4_lum ( short image [], const RESIDU *CurrResidu,  const short PicWidthInPix, const short W4x4_inter [6][16])
{
    int i8x8, i, j ;
    int index ;
    short luma_coeff [16];
