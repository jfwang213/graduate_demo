...
void Intra8x8_lum		( short image [], const RESIDU *CurrResidu, const short PicWidthInPix, const short W8x8_inter [6][64]);
void base_Intra8x8_lum  ( short image [], const RESIDU *CurrResidu, const short PicWidthInPix, const short W8x8_inter [6][64]);
