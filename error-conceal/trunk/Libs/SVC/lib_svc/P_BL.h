...
void Decode_BL_I(const PPS * Pps, const SPS * Sps, const NAL *Nal, RESIDU *residu, RESIDU *BaseResidu, const W_TABLES *quantif
				, short x, short y, short x_base, short y_base, short x_mbPartIdx, short y_mbPartIdx, short PicWidthInPix, short mbBaseAddr
