...
int slice_data_I_cabac ( RESIDU *picture_residu, unsigned char *data, int NalBytesInNalunit, 
						 SPS *sps, PPS *pps, DATA block [], SLICE *slice, int *aio_piPosition, 
						 unsigned char slice_table [], unsigned char MbToSliceGroupMap [], unsigned char *EndOfSlice );


int slice_data_P_cabac (RESIDU *picture_residu, unsigned char *data,int NalBytesInNalunit, SPS *sps, 
						 PPS *pps, DATA block [], SLICE *slice,int *aio_piPosition, unsigned char slice_table [], 
...
int slice_data_B_cabac ( RESIDU *picture_residu, unsigned char *data,int NalBytesInNalunit, SPS *sps, 
						 PPS *pps, DATA block [], SLICE *slice, int *aio_piPosition, unsigned char slice_table [],
						 unsigned char MbToSliceGroupMap [], short mv_cabac_l0[], short mv_cabac_l1[], short ref_cabac_l0[], 
						 short ref_cabac_l1[], unsigned char *EndOfSlice, LIST_MMO * ai_pRefPicListL1, short *mvl0_io, 
