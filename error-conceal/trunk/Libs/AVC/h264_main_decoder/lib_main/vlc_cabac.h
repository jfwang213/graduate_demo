...
int mb_pred_cabac ( CABACContext *c, unsigned char *state, SLICE *slice, RESIDU *CurrResidu, DATA *macroblock, 
...
int mb_pred_P_cabac (CABACContext *c, unsigned char *state, SLICE *slice, RESIDU *CurrResidu, short mv_cache_l0[][2], 
					  short ref_cache_l0[], short mvl0_cache[][2], short refl0_cache[]);

int sub_mb_pred_cabac (int *dct_allowed, CABACContext *c, unsigned char *state, SLICE *slice, RESIDU *Current_residu, 
						short mv_cache_l0[][2], short mv_cache_l1[][2], short ref_cache_l0[], short ref_cache_l1[], 
						short mvl0_cache[][2], short mvl1_cache[][2], short refl0_cache[], short refl1_cache[], 
...
int sub_mb_P_cabac ( int *dct_allowed, CABACContext *c, unsigned char *state, SLICE *slice, RESIDU *Current_residu, 
...
int decode_cabac_mb_skip			( CABACContext *c, unsigned char *state, int AvailMask, unsigned char slice_table[],  RESIDU *CurrResidu, int slice_type, int mb_xy, int mb_stride);
int decode_cabac_mb_ref				( CABACContext *c, unsigned char *state, int refa, int refb);
...
int decode_cabac_mb_mvd				( CABACContext *c, unsigned char *state, int mva, int mvb,int l );
