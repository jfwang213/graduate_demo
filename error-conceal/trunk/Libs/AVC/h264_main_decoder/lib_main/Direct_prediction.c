							   ...
							   int b8_stride, int direct_8x8_inference_flag, int long_term, int is_svc, int slice_type)
{
	...
	int refa = ref_cache_l0[12 - 1];
	int refb = ref_cache_l0[12 - 8];
	int refc = ref_cache_l0[12 - 8 + 4];
	...
	refa = ref_cache_l1[12 - 1];
	refb = ref_cache_l1[12 - 8];
	refc = ref_cache_l1[12 - 8 + 4];
	mvl1[0] = mv_cache_l1[12 - 8 + 4][0];
	mvl1[1] = mv_cache_l1[12 - 8 + 4][1];

	if(refc == -2){
		refc = ref_cache_l1[12 - 8 - 1];
		mvl1[0] = mv_cache_l1[12 - 8 -1][0];
		mvl1[1] = mv_cache_l1[12 - 8 -1][1];
	}
	ref[1] = refa;
	...
	if(ref[1] >= 0){
		int match_count = (refa == ref[1]) + (refb == ref[1]) + (refc == ref[1]);
		motion_pred(12, mv_cache_l1, mvl1, match_count, ref[1], refa, refb, refc);
	}else{
		mvl1[0] = mvl1[1] = 0;   
	}
								...
								int direct_8x8_inference_flag, int is_svc, const int slice_type)
{
	...
	if(ref0 >= 0){
		...
		mv_cache_l0[index + 9][0] = mv_cache_l0[index + 9][1] = 0;
		mv_cache_l1[index][0] = mv_cache_l1[index][1] = 
		mv_cache_l1[index + 1][0] = mv_cache_l1[index + 1][1] =
		mv_cache_l1[index + 8][0] = mv_cache_l1[index + 8][1] =
