...
static __inline void luma_sample_interp_2_n_h(unsigned char ptr_ref [RESTRICT], short tmp_res [RESTRICT], const short PicWidthSamples, const short stride)
{
	int i, j;
...
static __inline void luma_sample_interp_2_n_v(unsigned char image [RESTRICT], short tmp_res [RESTRICT], const short PicWidthSamples, const short stride)
{
	int i, j;
	for (i = 0; i < 4; i++)	{
