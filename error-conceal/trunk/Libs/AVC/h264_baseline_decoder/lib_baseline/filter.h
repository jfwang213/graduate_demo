...
void filter_mb_P( unsigned char image[], unsigned char image_Cb[], unsigned char image_Cr[], const SLICE *aio_pstSlice, 
				 unsigned char aio_pstSlice_table[], short mv_cache_l0[][2], short ref_cache_l0[], 
				 int PicWidthInMbs, const PPS *pps, const int x, const int y, const RESIDU *residu);

void filter_P( const SPS *aipstsps, const PPS *aipstpps, const SLICE *aio_pstSlice, unsigned char aio_pstSlice_table[], 
...
static int __inline bSCheckMvShort_C(short mva[2], short mvb[2]){
