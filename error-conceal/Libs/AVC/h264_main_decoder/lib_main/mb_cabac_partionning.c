...
*/
int mb_cabac_I_partionning (RESIDU *picture_residu, SLICE *slice, DATA Tab_block[],	DATA *block, 
...
{  
	...
	if ( picture_residu -> MbType == INTRA_PCM ) {
		...
		fill_caches_I( slice, picture_residu, 1, non_zero_count_cache, block, slice_table, 
...
*/
int mb_cabac_P_partionning (RESIDU *picture_residu, SLICE *slice, DATA Tab_block[], DATA block[], 
							 unsigned char non_zero_count_cache [], unsigned char slice_table [], int iCurrMbAddr, 
...
{  
	...
	//Updating the parameter in order to decode the VLC
	fill_caches( slice, picture_residu, 1, non_zero_count_cache, block, slice_table, x, y);
	fill_caches_cabac (slice, neigh, slice_table, iCurrMbAddr, *mb_qp_delta, picture_residu);
...
*/
int mb_cabac_B_partionning (RESIDU *picture_residu, SLICE *slice , DATA Tab_block[], unsigned char non_zero_count_cache [], 
							 ...
							 short x, short y, int direct_8x8_inference_flag, int dct_allowed, int *last_QP, int *mb_qp_delta, 
