...
void ref_pic_list_reordering ( unsigned char *data,int *aio_piPosition, SLICE *aio_pstSlice,
...
void init_slice ( SLICE *aio_pstSlice );
void reinit_slice ( SLICE *aio_pstSlice );
...
void Slice_layer_without_partitioning_rbsp ( unsigned char *ai_pcData, const int *ai_piNalBytesInNalunit, const int *aio_piPosition, 
											const SPS *Sps, PPS *Pps, VLC_TABLES *Vlc, int aio_tiNon_zero_count_cache [ ],
											STRUCT_PF *pf_struct, int *ai_aio_pstSlice_group_id, SLICE *aio_pstSlice, 
											int aio_tiMbToSliceGroupMap [ ], int aio_pstSlice_table [ ], DATA aio_tstBlock [ ], 
