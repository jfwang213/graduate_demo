...
void Slice_data_P( const SPS *Sps, const PPS *Pps,const SLICE *aio_pstSlice, const unsigned char aio_pstSlice_table [ ], 
				  RESIDU *picture_residu, const STRUCT_PF * ai_STRUCT_PF, LIST_MMO *ai_pstRefPicListL0, short aio_tiMv [ ],
				  short aio_tiRef [ ],  unsigned char aio_tucDpb_luma[ ], unsigned char aio_tucDpb_Cb[ ], unsigned char  aio_tucDpb_Cr[ ], 
