...
/**
This function permits to determine in which aio_pstSlice, each macroblock belong to according to the image structure. 

@param Pps The pps structure.
@param ao_tiMapUnitToSliceGroupMap A table which contains the aio_piPosition of each macroblock in a aio_pstSlice according to the image structure. 
@param ai_islice_group_change_cycle It's used to derive the number of aio_pstSlice group map units.
