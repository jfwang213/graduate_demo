...
/*
	for (j = 0; j < 13; j++, ptr_ref += PicWidthSamples){		
		...
		ref64_1 = *((__m64*)&ptr_ref[0]);
		ref64_2 = *((__m64*)&ptr_ref[8]);

		tmp_resul[j + 0] = ref64_1.m64_u8[0] + ref64_1.m64_u8[5] - 5 * (short)(ref64_1.m64_u8[1] + ref64_1.m64_u8[4]) + 20 * (short)(ref64_1.m64_u8[2] + ref64_1.m64_u8[3]);
		tmp_resul[j + 13] = ref64_1.m64_u8[1] + ref64_1.m64_u8[6] - 5 * (short)(ref64_1.m64_u8[2] + ref64_1.m64_u8[5]) + 20 * (short)(ref64_1.m64_u8[3] + ref64_1.m64_u8[4]);
		tmp_resul[j + 26] = ref64_1.m64_u8[2] + ref64_1.m64_u8[7] - 5 * (short)(ref64_1.m64_u8[3] + ref64_1.m64_u8[6]) + 20 * (short)(ref64_1.m64_u8[4] + ref64_1.m64_u8[5]);
		tmp_resul[j + 39] = ref64_1.m64_u8[3] + ref64_2.m64_u8[0] - 5 * (short)(ref64_1.m64_u8[4] + ref64_1.m64_u8[7]) + 20 * (short)(ref64_1.m64_u8[5] + ref64_1.m64_u8[6]);
		tmp_resul[j + 52] = ref64_1.m64_u8[4] + ref64_2.m64_u8[1] - 5 * (short)(ref64_1.m64_u8[5] + ref64_2.m64_u8[0]) + 20 * (short)(ref64_1.m64_u8[6] + ref64_1.m64_u8[7]);
		tmp_resul[j + 65] = ref64_1.m64_u8[5] + ref64_2.m64_u8[2] - 5 * (short)(ref64_1.m64_u8[6] + ref64_2.m64_u8[1]) + 20 * (short)(ref64_1.m64_u8[7] + ref64_2.m64_u8[0]);
		tmp_resul[j + 78] = ref64_1.m64_u8[6] + ref64_2.m64_u8[3] - 5 * (short)(ref64_1.m64_u8[7] + ref64_2.m64_u8[2]) + 20 * (short)(ref64_2.m64_u8[0] + ref64_2.m64_u8[1]);
		tmp_resul[j + 91] = ref64_1.m64_u8[7] + ref64_2.m64_u8[4] - 5 * (short)(ref64_2.m64_u8[0] + ref64_2.m64_u8[3]) + 20 * (short)(ref64_2.m64_u8[1] + ref64_2.m64_u8[2]);
	}*/
...
/*	
	for (i = 0; i < 8; i++){
		...
		ref64_2 = *((__m64*)&tmp[4]);
		ref64_3 = *((__m64*)&tmp[8]);
		ref64_4 = *((__m64*)&tmp[12]);

		ref64_5.m64_i16[0] = (ref64_1.m64_i16[0] + ref64_2.m64_i16[1] - 5 * (short)(ref64_1.m64_i16[1] + ref64_2.m64_i16[0]) + 20 * (short)(ref64_1.m64_i16[2] + ref64_1.m64_i16[3])) >> 5;
		ref64_5.m64_i16[1] = (ref64_1.m64_i16[1] + ref64_2.m64_i16[2] - 5 * (short)(ref64_1.m64_i16[2] + ref64_2.m64_i16[1]) + 20 * (short)(ref64_1.m64_i16[3] + ref64_2.m64_i16[0])) >> 5;
		ref64_5.m64_i16[2] = (ref64_1.m64_i16[2] + ref64_2.m64_i16[3] - 5 * (short)(ref64_1.m64_i16[3] + ref64_2.m64_i16[2]) + 20 * (short)(ref64_2.m64_i16[0] + ref64_2.m64_i16[1])) >> 5;
		ref64_5.m64_i16[3] = (ref64_1.m64_i16[3] + ref64_3.m64_i16[0] - 5 * (short)(ref64_2.m64_i16[0] + ref64_2.m64_i16[3]) + 20 * (short)(ref64_2.m64_i16[1] + ref64_2.m64_i16[2])) >> 5;
		ref64_6.m64_i16[0] = (ref64_2.m64_i16[0] + ref64_3.m64_i16[1] - 5 * (short)(ref64_2.m64_i16[1] + ref64_3.m64_i16[0]) + 20 * (short)(ref64_2.m64_i16[2] + ref64_2.m64_i16[3])) >> 5;
		ref64_6.m64_i16[1] = (ref64_2.m64_i16[1] + ref64_3.m64_i16[2] - 5 * (short)(ref64_2.m64_i16[2] + ref64_3.m64_i16[1]) + 20 * (short)(ref64_2.m64_i16[3] + ref64_3.m64_i16[0])) >> 5;
		ref64_6.m64_i16[2] = (ref64_2.m64_i16[2] + ref64_3.m64_i16[3] - 5 * (short)(ref64_2.m64_i16[3] + ref64_3.m64_i16[2]) + 20 * (short)(ref64_3.m64_i16[0] + ref64_3.m64_i16[1])) >> 5;
		ref64_6.m64_i16[3] = (ref64_2.m64_i16[3] + ref64_4.m64_i16[0] - 5 * (short)(ref64_3.m64_i16[0] + ref64_3.m64_i16[3]) + 20 * (short)(ref64_3.m64_i16[1] + ref64_3.m64_i16[2])) >> 5;
		
		ref64_5 = _mm_add_pi16(ref64_5,cst16);
		ref64_5 = _mm_srai_pi16(ref64_5,5);
		ref64_6 = _mm_add_pi16(ref64_6,cst16);
		ref64_6 = _mm_srai_pi16(ref64_6,5);
		ref64_5 = _mm_packs_pu16(ref64_5,ref64_6);

		ptr_img[0] = ref64_5.m64_u8[0];
		ptr_img[stride] = ref64_5.m64_u8[1];
		ptr_img[2*stride] = ref64_5.m64_u8[2];
		ptr_img[3*stride] = ref64_5.m64_u8[3];
		ptr_img[4*stride] = ref64_5.m64_u8[4];
		ptr_img[5*stride] = ref64_5.m64_u8[5];
		ptr_img[6*stride] = ref64_5.m64_u8[6];
		ptr_img[7*stride] = ref64_5.m64_u8[7];
	}
*/
