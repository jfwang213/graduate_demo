...
void get_base_neighbourhood(short *Mask,  short Addr,  const short iAddr_x, const int PicWidthInMbs, const RESIDU * residu,  const int PicSizeInMbs, const int IntraConstrained);
