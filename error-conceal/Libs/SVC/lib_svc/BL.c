...
/**
This function upsample an Intra macroblock to get a part of the current macroblock.
The result is stored in a temporay table, in order to be saved during the inter prediction.
*/
