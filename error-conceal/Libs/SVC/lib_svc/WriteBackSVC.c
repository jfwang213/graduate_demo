										  ...
										  short aio_tiRef_cache_l0[ ], short aio_tiRef_cache_l1[ ],int mb_stride)
{
	...
	for(y = 0; y < 4; y++, refl0 += ai_iB8_stride){
		aio_tiRef_cache_l0[12 + 8 * y] = refl0[0];
		aio_tiRef_cache_l0[13 + 8 * y] = refl0[1];
		aio_tiRef_cache_l0[14 + 8 * y] = refl0[2];
		aio_tiRef_cache_l0[15 + 8 * y] = refl0[3];
	}

	for(y = 0; y < 4; y++, refl1 += ai_iB8_stride){
		aio_tiRef_cache_l1[12 + 8 * y] = refl1[0];
		aio_tiRef_cache_l1[13 + 8 * y] = refl1[1];
		aio_tiRef_cache_l1[14 + 8 * y] = refl1[2];
		aio_tiRef_cache_l1[15 + 8 * y] = refl1[3];
	}
    ...
    if(top_xy >= 0)   {
        ...
        aio_tiRef_cache_l0[4] = ai_tiRef_l0[- ai_iB8_stride];
		aio_tiRef_cache_l0[5] = ai_tiRef_l0[1 - ai_iB8_stride];
        aio_tiRef_cache_l0[6] = ai_tiRef_l0[2 - ai_iB8_stride];
		aio_tiRef_cache_l0[7] = ai_tiRef_l0[3 - ai_iB8_stride];    

        aio_tiRef_cache_l1[4] = ai_tiRef_l1[- ai_iB8_stride];
		aio_tiRef_cache_l1[5] = ai_tiRef_l1[1 - ai_iB8_stride];
        aio_tiRef_cache_l1[6] = ai_tiRef_l1[2 - ai_iB8_stride];
		aio_tiRef_cache_l1[7] = ai_tiRef_l1[3 - ai_iB8_stride];   
