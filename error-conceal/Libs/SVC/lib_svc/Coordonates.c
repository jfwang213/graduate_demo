...
/**
G.8.6.1
Give for each block 4x4, the base position and its reference block 4x4 in the base macroblock
*/
int InitializeBaseIndex(const NAL *Nal, short x, short y, REFPART RefPartition[16], RESIDU *BaseResidu, RESIDU *Residu)
{
...
/**
Compute for each macroblock the mode of the macroblock according to base layer macroblock.
*/
...
/**
Compute for each B macroblock the mode of the macroblock according to base layer macroblock.
*/
