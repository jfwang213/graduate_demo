...
int SubMbPCabacSVC ( int *dct_allowed, CABACContext *c, unsigned char *state, SLICE *slice, DATA *macroblock, RESIDU *Current_residu, short mv_cache_l0[][2], short  ref_cache_l0[]);
...
int MbPredPCabacSvc ( CABACContext *c, unsigned char *state, SLICE *slice, RESIDU *CurrResidu, DATA *macroblock, short mv_cache_l0[][2], short ref_cache_l0[]);
int MbPredBCabacSvc ( CABACContext *c, unsigned char *state, SLICE *Slice, RESIDU *CurrResidu, DATA *macroblock, short mv_cache_l0[][2], 
...
*/
static __inline int CabacGetMotionPredFlag(CABACContext *c, unsigned char *state, int Idx)
{

	return get_cabac( c, &state[463 + Idx]);
}
