...
void fill_caches_svc ( const SLICE *ai_pstSlice, const RESIDU *residu, const RESIDU *BaseResidu, const int ai_iEntropy_coding_mode_flag, 
					  unsigned char aio_tiNon_zero_count_cache [], const unsigned char ai_tiSlice_table [ ], const DATA *CurrBlock,
...
void fill_caches_motion_vector_full_ref(  const SLICE *ai_pstSlice, const int ai_iB_stride, const int ai_iB8_stride, 
										...
										const unsigned char ai_tiSlice_table [ ], const RESIDU CurrResidu [ ], short ai_tiMv[  ], 
...
void fill_caches_full_ref(  const SLICE *ai_pstSlice, const int ai_iB_stride, const int ai_iB8_stride, short aio_tiRef_cache_l0 [ ], 
						  short aio_tiMv_cache_l0[ ][2], const unsigned char ai_tiSlice_table [ ], const RESIDU CurrResidu [ ],
